...
//   const erc404rb = await ST404.deploy('ST404 Alpha Testing v4', 'RBTT', decimals, initialOwnerBalance, "0x851438Ecb37FAe596DcD49bDe643D170F3aa225B", "0x851438Ecb37FAe596DcD49bDe643D170F3aa225B", 1000n, 2000);
//   const erc404st = await ST404.deploy('ST404 Testing Token v4', 'STTT4', decimals, initialOwnerBalance, "0x6DDD22a9bCc22811BEc8786d2090F7381Dcd22e8");
  const erc404st = await ST404.deploy('ST404 Testing Token v4', 'STTT4', decimals, initialOwnerBalance, "0x851438Ecb37FAe596DcD49bDe643D170F3aa225B", "0x851438Ecb37FAe596DcD49bDe643D170F3aa225B", 10000);
