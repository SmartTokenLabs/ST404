...
async function main() {
  ...
  const erc404st = await ST404.deploy('ZipCoin', 'ZIP', decimals, initialOwnerBalance, "0x851438Ecb37FAe596DcD49bDe643D170F3aa225B", "0x9c4171b69E5659647556E81007EF941f9B042b1a", 1000n);
