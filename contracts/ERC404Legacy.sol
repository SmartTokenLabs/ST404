...
abstract contract ERC404Legacy is Ownable {
    ...
    // ERC721: function approve(address to, uint256 tokenId) external;
    // ERC20: function approve(address spender, uint256 value) external returns (bool);
    function approve(address spender, uint256 amountOrId) external virtual returns (bool) {
